...
<div class="main-content" data-entity="teacher-courses">
    ...
    <div class="filter-card">
        <form action="{{ route('teacher.course') }}" method="GET" class="row align-items-center">
            ...
            <div class="col-md-3 d-flex" style="gap: 8px;">
                ...
                @if(request('search'))
                <a href="{{ route('teacher.course') }}" class="btn btn-light" style="border-radius: 8px;" title="Reset Search">
    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h2 class="mb-0">Course Curriculum Directory</h2>
                </div>
                ...
                <tbody>
                    ...
                    <tr data-row-id="{{ $course->id }}">
                        ...
                        <td class="text-center">
                            <a href="#editCourseModal" class="btn-action btn-action-edit teacher-edit-course-trigger" data-toggle="modal"
                            ...
                            <a href="#deleteCourseModal" class="btn-action btn-action-delete teacher-delete-course-trigger" data-toggle="modal"
                    ...
                    <div class="modal-body py-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="add-course-name" name="course_name" class="form-control"
                                placeholder="e.g. Physics I" value="{{ old('course_name') }}" required>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="number" id="add-course-fee" name="fee" class="form-control"
                                placeholder="e.g. 2000" value="{{ old('fee') }}" min="0" required>
            ...
            <form action="{{ route('tEditCourse') }}" method="POST">
                ...
                <div class="modal-content shadow border-0" style="border-radius: 12px;">
                    ...
                    <div class="modal-body py-3">
                        ...
                        <div class="form-group">
                            <label for="teacher-edit-course-name" class="font-weight-bold text-muted small">Course Title</label>
                        ...
                        <div class="form-group">
                            <label for="teacher-edit-course-credit-hours" class="font-weight-bold text-muted small">Credit Hours</label>
                        ...
                        <div class="form-group mb-0">
                            <label for="teacher-edit-course-fee" class="font-weight-bold text-muted small">Tuition Fee (Rs.)</label>
        ...
        <div class="modal-dialog" role="document">
            <form action="{{ route('tDeleteCourse') }}" method="POST">
                ...
                <div class="modal-content shadow border-0" style="border-radius: 12px;">
                    ...
                    <div class="modal-body py-3">
                        <input type="hidden" name="course_id" id="teacher-delete-course-id" value="{{ old('course_id') }}">
                        <p id="teacher-delete-course-message" class="mb-1 text-dark">Are you sure you want to delete this course?</p>
    ...
    <div class="modal fade" tabindex="-1" id="teacherBulkDeleteCoursesModal" role="dialog" aria-labelledby="teacherBulkDeleteCoursesModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ route('tBulkDeleteCourses') }}" method="POST" id="teacherBulkDeleteCoursesForm">
                @csrf
                <div class="modal-content shadow border-0" style="border-radius: 12px;">
                    <div class="modal-header border-bottom-0 pb-0">
                        <h5 class="modal-title font-weight-bold text-danger" id="teacherBulkDeleteCoursesModalLabel">Delete Selected Courses</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body py-3">
                        <p id="teacher-bulk-delete-courses-message" class="mb-1 text-dark">Are you sure you want to delete the selected courses?</p>
