                  ...
                  <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
                          ...
                          {{-- <a href="#deleteCourseModal" class="btn btn-danger" data-toggle="modal">
                          <i class="material-icons">&#xE15C;</i>
                          <span>Delete</span> --}}
                          </a>
                        </div>
                     ...
                     <tbody>
                        ...
                        @forelse($course as $data)
                            ...
                            <tr>
                                ...
                                <th>
                                  <a href="#editCourseModal" class="edit" data-toggle="modal" data-id="{{ $data->course_id }}">
                                    <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                </a>
                                
                                   <a href="#deleteCourseModal" class="delete" data-toggle="modal" data-id="{{ $data->course_id }}">
