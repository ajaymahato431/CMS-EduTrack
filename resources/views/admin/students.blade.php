...
<div class="main-content" data-entity="students">
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="flex p-0 col-sm-6 justify-content-lg-end justify-content-center">
                            <button type="button" class="mr-2 btn btn-danger" id="bulkDeleteStudentsButton">
    ...
    <div class="modal fade" tabindex="-1" id="addStudentModal" role="dialog" aria-labelledby="addStudentModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="add-student-course" name="course_id" class="form-control" required>
                                ...
                                <option value="{{ $courseOption->id }}" {{ (string) old('course_id')===(string)
                                    $courseOption->id ? 'selected' : '' }}>
    ...
    <div class="modal fade" tabindex="-1" id="editStudentModal" role="dialog" aria-labelledby="editStudentModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
...
<script>
    $(document).ready(function() {
        ...
        $('#editStudentModal').on('show.bs.modal', function(event) {
            ...
            modal.find('#edit-student-name').val(name);
            modal.find('#edit-student-sex').val(sex);
            modal.find('#edit-student-phone').val(phone);
            modal.find('#edit-student-address').val(address);
            modal.find('#edit-student-course').val(courseId);
            modal.find('#edit-student-fee').val(fee);
        });
        ...
        $('#deleteStudentModal').on('show.bs.modal', function(event) {
            ...
            modal.find('#delete-student-id').val(studentId);
            modal.find('#delete-student-message').text('Are you sure you want to delete student "' + name + '"?');
        });
    });
</script>
@endpush
